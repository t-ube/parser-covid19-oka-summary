...
def output_dummy(path):
    ...
    linePDF.rect(20.3, 120.9, 0.75, 110.6,'F')
    linePDF.set_fill_color(0,0,0)
    linePDF.rect(38.3, 120.9, 0.75, 110.6,'F')
    linePDF.set_fill_color(0,0,0)
    linePDF.rect(45.3, 120.9, 0.75, 110.6,'F')
    linePDF.set_fill_color(0,0,0)
    linePDF.rect(128.4, 120.9, 0.5, 110.6,'F')
    linePDF.set_fill_color(0,0,0)
    linePDF.rect(156.7, 120.9, 0.5, 110.6,'F')
    linePDF.set_fill_color(0,0,0)
